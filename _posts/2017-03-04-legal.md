...
code: |
 ...
 article header {background:black; color:#f7f7f7; height:100vh; padding-top:25vh}
...
<p class="image"><img src="http://i.imgur.com/joDoL.gif" class="lazyload" /></p>
</div>
</div>
...
<div class="column" markdown="1">
PS: In the very last dispute box you only get 250 characters so link OUT to this cv (because it's a shorter word than resume or portfolio, see?) and make your case there. If you don't have a website you could put it up on a permanent page on your tumblr, or [send it to me](/about/contact) and I will host it for you on limvids. I will also write you a testimonial you can put on there if you need one.
</div>
</div>
